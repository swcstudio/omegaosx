...
OmegaOS W3.x is a _secure_, _fast_, and _general-purpose_ OS kernel
that provides an _Linux-compatible_ ABI.
It can serve as a seamless replacement for Linux
while enhancing _memory safety_ and _developer friendliness_.

* OmegaOS W3.x prioritizes memory safety
...
establishes OmegaOS W3.x as a more secure and dependable kernel option.

* OmegaOS W3.x surpasses Linux in terms of developer friendliness.
...
Follow the three simple steps below to get OmegaOS W3.x up and running.
...
3. Inside the container, go to the project folder to build and run OmegaOS W3.x.
...
If everything goes well, OmegaOS W3.x is now up and running inside a VM.
