...
OmegaOS W3.x is dedicated to maintaining compatibility with the Linux ABI,
ensuring that applications and administrative tools
designed for Linux can seamlessly operate within OmegaOS W3.x.
While we prioritize compatibility,
it is important to note that OmegaOS W3.x does not,
...
OmegaOS W3.x supports over 220 Linux system calls for the x86-64 architecture,
