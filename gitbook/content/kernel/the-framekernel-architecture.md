...
OmegaOS W3.x introduces a novel OS architecture called _framekernel_,
...
OmegaOS W3.x can offer both exceptional performance and enhanced safety.
...
have borne fruit in the form of the [OmegaOSX OSTD](../ostd/).
Using this framework as a foundation,
we have developed the OmegaOS W3.x Kernel;
